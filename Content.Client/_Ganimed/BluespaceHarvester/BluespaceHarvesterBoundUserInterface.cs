using Content.Shared._Ganimed.BluespaceHarvester;
using JetBrains.Annotations;

namespace Content.Client._Ganimed.BluespaceHarvester;
...
public sealed class BluespaceHarvesterBoundUserInterface : BoundUserInterface
{
    ...
    public void SendBuy(Shared._Ganimed.BluespaceHarvester.BluespaceHarvesterCategory category)
    {
