...
public abstract partial class SharedDoorSystem : EntitySystem
{
    ...
    public virtual void StartOpening(EntityUid uid, DoorComponent? door = null, EntityUid? user = null, bool predicted = false) // Ganimed-DoorForensics
    {
        if (!Resolve(uid, ref door))
            return;
    ...
    public virtual void StartClosing(EntityUid uid, DoorComponent? door = null, EntityUid? user = null, bool predicted = false) // Ganimed-DoorForensics
    {
        if (!Resolve(uid, ref door))
            return;
