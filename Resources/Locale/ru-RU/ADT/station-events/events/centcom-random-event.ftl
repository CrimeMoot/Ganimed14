...
centcom-random-event-sighting-2 = все члены экипажа должны носить { $clothing }. Нарушение данного закона приравнивается к нарушению статьи 301.
centcom-random-event-sighting-3 = слово { $word } запрещено к использованию. Нарушение данного закона приравнивается к нарушению статьи 106.
centcom-random-event-sighting-4 = любые шутки произнесенные экипажем запрещены. Нарушение данного закона приравнивается к нарушению статьи 100.
centcom-random-event-sighting-5 = запрещено бегать на станции. Нарушение данного закона приравнивается к нарушению статьи 106.
...
centcom-random-event-sighting-7 = быть компетентным запрещено и наказуемо в соответствии со статьей 301.
centcom-random-event-sighting-8 = { $clothing } запрещены и должны быть изъяты службой безопасности. Нарушение данного закона приравнивается к нарушению статьи 205.
centcom-random-event-sighting-9 = запрещено использовать { $generator } для получения электро-энергии, так как отдел по технике безопасности признал данный источник энергии крайне опасным. Нарушение данного закона приравнивается к нарушению статьи 401.
...
centcom-random-event-sighting-11 = экипажу запрещено иметь на своем лице растительность. Нарушение данного закона приравнивается к нарушению статьи 106.
centcom-random-event-sighting-12 = запрещено выращивать { $plant }. Нарушение данного закона приравнивается к нарушению статьи 404.
centcom-random-event-sighting-13 = запрещено быть инвалидом. Нарушение данного закона приравнивается к нарушению статьи 510.
centcom-random-event-sighting-14 = теперь датчики должны быть { $mode }. Нарушение данного закона приравнивается к нарушению статьи 301.
centcom-random-event-sighting-15 = любая музыка запрещена. Нарушение данного закона приравнивается к нарушению статьи 106.
centcom-random-event-sighting-16 = запрещено любое физическое передвижения кроме { $movement }. Нарушение данного закона приравнивается к нарушению статьи 106.
