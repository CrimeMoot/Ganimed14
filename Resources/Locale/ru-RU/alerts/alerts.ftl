...
alerts-revenant-essence-name = Сущность

alerts-revenant-essence-desc = Сила душ.Он поддерживает вас и используется для способностей.Это медленно восстанавливается с течением времени.

alerts-revenant-corporeal-name = Телесный

alerts-revenant-corporeal-desc = Вы проявились физически.Люди вокруг вас могут видеть и причинять вам боль.

ui-options-function-toggle-crawling = Перевернуть ползание
