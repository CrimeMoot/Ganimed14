...
book-halifat-contents =
    ...
    1) Наиболее влиятельным и богатым предписывается, если их присутствие в данный момент не критично важно для страны, посетить пространство ТСФ, прилететь на Землю, дабы вознести там свои молитвы на священной Мусульманской земле. Тоже предписывается и религиозным деятелям и истинно правоверным.
...
book-zp-contents =
    ...
    Коэффициенты по рождению -- Родился на территории ТСФ – 1,05 Родился на территории корпорации – 1,10 Родился на иных территориях - 1,0
...
book-mirt-contents =
    ...
    Согласно религиозным убеждениям души погибших от ксеноморфов не пропадают, а попадают в Цитадель Миртана! В небесный чертог вечных солдат. Там они готовятся к последнему Бою императора. Когда Три Линии падут, когда рой захлестнёт Империю, когда дойдёт до границ ТСФ, Явится Император Миртан и его павшее воинство в последний раз. Они остановят рой на один год и один день, чтобы дать галактике подготовиться к бою. Затем они передадут флаг и бремя смерти ТСФ и исчезнут в бесконечности космоса…
...
book-gior-contents =
    ГИОР (Галактическая Инициатива Объединённых Рас) – это исполнительный комитет межрасового надгосударственного общения, сформированный ТСФ, после обнаружения первых инопланетных рас (Унатхов, Дворфов и Ниан), идейно ГИОР пришла на замену ООН, организации, некогда созданной на земле. По сути, целью ГИОР является урегулирование разнообразных конфликтов в галактике, собрание её участниц на заседаниях, которые проводятся раз в 5 лет, выдвижение каких, либо резолюций, а также контроль за соблюдением принятых законов.
    ...
    3) Галактическая Инициатива Объединённых Рас и Корпоративного Урегулирования (ГИОРиКУ), была создана относительно недавно в 2781 году, в ответ на разрешение, выданное правительством ТСФ, корпорациям на освоение регионов фронтира. Занимается контролем за исполнением принятых резолюций и соглашений, а также подписанием новых. При этом ГИОРиКУ имеет огромную когорту своих представителей, которые постоянно находятся в разъездах по всей галактике и занимаются отслеживанием нарушений.
    
    
    4) Совет Безопасности Галактической Инициативы Объединённых Рас (СовБезГИОР), самая «молодая» организация в составе ГИОР. Занимается тем, что отслеживает всевозможные угрозы галактике, а также старается их предотвратить. Самой первой и на данный момент единственной задачей является отслеживание ситуации с ксеноморфами, а также всевозможная поддержка государств, которые занимаются урегулированием данной проблемы. Постоянными членами СовБезГИОР) являются ТСФ и Империя Миртана (не смотря на статус наблюдателя в заседаниях самой ГИОРиГУ, с недавних пор Империя Миртана обладает особым правовым статусов в СовБезГИОР из-за того, что именно она является щитом галактики от угрозы ксеноморфов).
    
    Также в состав СовБезГИОР входят все остальные государства и организации, которые входят в ГИОРиГУ
book-snk-contents =
    С ТСФ ведётся постоянная борьба за право на существование. СНК считает ТСФ жадными до власти и денег тиранами, которые не уделяют должного внимания как народу, так и развитию своего рынка, черпая деньги с любых источников и невзирая на благосостояние своих граждан – именно так вела себя ТСФ на момент формирования условий для революции СНК. Грызня между СНК и ТСФ не прекратится до тех пор, пока ТСФ будет иметь претензии как на территории СНК, так и на сам факт его существования.
    ...
    К Ноократии Эранта СНК относится нейтрально. Ноократия в своё время также пошла против ТСФ, что принималось одобрительно со стороны СНК, так как это могло значить появление ценного союзника в будущих конфликтах. К всеобщему удивлению, ТСФ спокойно согласилось принять независимость при условии выполнения ряда требований, чему СНК могло лишь позавидовать. На данный момент в Ноократии есть филиалы компаний СНК, а сама Ноократия рассматривается скорее как поставщик ценного технологического оборудования и кладезь выдающихся ученых, что крайне интересуют как отделы разработок отдельных компаний СНК, так и всего государства в целом.
    
    Правительством СНК проводятся мероприятия по налаживанию безопасности торговых путей с Халифатским Божественным Конгломератом, постепенно налаживая активную торговлю и культурный обмен. Однако дальнейшему укреплению дружеских отношений препятствуют активные боевые действия с ТСФ и неготовность Конгломерата принимать чью-либо сторону. Не менее важной проблемой является подрывная пиратская деятельность Межпланетарного Братства на торговых маршрутах.
    
    Отношения между СНК и СССП находятся в висячем положении. Политика СНК во многом отличается от ТСФ, но государство целиком и полностью продолжает полагаться на частные компании, куда меньше ограничивая их в сравнении с компаниями ТСФ. Они обрели непозволительное для СССП влияние и силу, а также создали огромный разрыв между финансами и влиянием жителей. С другой стороны — именно возгоревшийся очаг революции зарождающейся СНК дал возможность СССП отделиться от ТСФ относительно бескровно, ровно как и тихий переворот СССП стал ключевым фактором для ТСФ в прекращении полномасштабных боевых действий против СНК, давая последним время окрепнуть.
    ...
    Межпланетарное братство удостоилось особого внимания со стороны СНК, ведь именно Братство, по мнению СНК, может стать очередным столь востребованным союзником в борьбе против ТСФ, благодаря которому можно значительно расширить информационную сеть. Правда, действия отдельных группировок братства на территориях СНК, порой, носят абсолютно не дружественный характер. Примером могут послужить многочисленные улики, что напрямую указывают на причастность семьи Дилли Джонса к террористическим актам на государственных заводах СНК.
    
    Конечно же и в ГИОР есть представители СНК. Если отношения с ТСФ вновь достигнут войны, то именно возможность воззвать к жалости остальных членов ГИОР может помочь быстро пресечь военный конфликт. В других случаях, особых отношений с ГИОР нет. Можно сказать, что предоставляемая СНК помощь и степень выполнения требований ГИОР в основном зависит от настроения компаний СНК.
    
    С НТ правительство СНК связывает закупка некоторые патентов и научных статей, которые могли бы так или иначе помочь улучшить эффективность своих войск и получить преимущество над ТСФ. Иные же технологии покупаются отдельными корпорациями, учреждениями и, в общей сложности, разношерстными бизнесменами. Также СНК неоднократно намекало НТ, что если та в будущем решит выйти из состава ТСФ насильственным способом, то СНК готово предоставить ей место в своем реестре и военную помощь в обмен на финансирование правительства. Потеря НТ была бы крайне сильным ударом для ТСФ и значительным дополнением казны СНК.
book-umpor-contents =
    В своё время ТСФ попросту отпустила Ноократию Эранта и Умпорскую Федерацию, когда они ещё были единым государством. Им было невыгодно содержать эти колонии, где было население, но не было богатых месторождений ресурсов. Сейчас под небольшим давлением ГИОР ТСФ посылает в Федерацию гуманитарную помощь и торгует некоторыми товарами через Корпоративную Зону большой пятёрки. Но помощь эта весьма нерегулярна и порой, чтобы её получить, посольским делегациям Федерации приходится чуть ли не умолять и идти на крайне чувствительные политические уступки.
...
book-vitz-contents =
    ...
    Два лёгких космических судна сделанных на манер истребителей-Разведчиков ТСФ (машина класса «Комар» по документам Vitezstvi), но с облегчённой бронёй, большей скоростью и более слабыми орудиями. Пара состоит из ведущего и ведомого. Предназначена для скрытной авиаразведки. Часто авиапары посылают на простые задания и ставят в них новичков, чтобы они освоились перед настоящими опасными делами.
    
    
    2) Истребительная авиапара
    
    Два лёгких космических судна сделанных на манер истребителей-перехватчиков ТСФ (машина класса «Лилия» по документам Vitezstvi). Пара состоит из ведущего и ведомого. Предназначена для патрулирования и охраны. Часто в пару к опытному ведущему-ветерану ставят ведомого-юнца, чтобы быстрей обучить его.
...
book-gefest-contents =
    ...
    Несколько веков бизнес Гефеста развивался в соответствии со всем миром, однако плазмы, впрочем, как и нефти было недостаточно, относительно масштабов ТСФ. И если нефтяные месторождения можно найти на планетах с жизнью, то с плазмой дела обстояли сложнее. Руководство корпорации стремилось решить проблему плазменного и нефтяного голода.
    ...
    Экономика ТСФ требовала всё больше и больше плазмы, и с течением времени идеи о колонизации фронтира не казались такими дорогими как это могло показаться на первый взгляд. Череда удачных событий привела Гефест на фронтир. Вслед за Гефестом проследовали и другие корпорации.
...
book-conarex-contents =
    2706 год. Эмиль Хотакайнен, владелец крупной компании по производству и продаже изделий медицинско-интимно-постельного применения, чьи магазины действовали по всему ТСФ, составил завещание, оставив всю свою компанию старшему 28-милетнему сыну Симо.
    ...
    2788 год. Conarex помогает посольским делегациям ТСФ и ГИОР начать мирные переговоры между Умпорской Федерацией и Ноократией Эранта. ТСФ востанавливает лицензию Conarex на производственную и транспортную деятельность в своих границах.
    ...
    2836 год. Conarex распространилась по всей Великой Империи Нотда. А также пользуется старой лицензией в ТСФ, чтобы распространить своё влияние на два их сектора. Conarex уж производит всё необходимое для шаттлов.
...
book-petr-contents =
    Петрищевцы верят, что единственный и необходимый путь для галактики — переход к Коммунистическим ценностям. Но Галактика отказалась это сделать мирно, когда отцы-революционеры СССП предложили это. Революция в ТСФ показала, что социалисты и коммунисты могут сражаться за свои идеалы. После при образовании Петрищевцев выработалась идея, что истинные коммунисты должны, просто обязаны бороться со всем миром.
...
book-saibasan-contents =
    ...
    Активы корпорации
    По большому счёту Saibasan обеспечивает электроникой (по примерноым расчётам) 4 сектора Фронтира, 2 сектора ТСФ, 2 сектора Умпорской Федерации и 1 Сектор СНК. Посему у корпорации 45 заводов, 121 дизайн-центр, 9 технологических лабораторий и 10 административных отделений, одно из которых главное.
...
book-unath-ptwo-contents =
    ...
    Война с воксами, возникновение ненавидящей всех нелюдей Миртанийской Империи и военное присутствие ТСФ пошатнули повальную веру в послевоенные идеалы. Часть унатхов начала рассматривать войну и армию как необходимые инструменты для обеспечения дальнейшего существования унатхской цивилизации, а пацифизм — как проявление слабости перед лицом неумолимого врага. Популярность унатхов в качестве солдат ТСФ и наемников также повысила привлекательность милитаристских настроений. В наши дни военный сектор Моргха Унатх постепенно набирает во влиянии и богатстве, что выливается в растущее недовольство идеологической миролюбивостью.
book-dione-contents =
