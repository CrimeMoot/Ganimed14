...
id-card-access-level-captain = Предстансовет
id-card-access-level-head-of-personnel = Начальник персонала
...
id-card-access-level-quartermaster = Завхоз
id-card-access-level-cargo = Снабжение
id-card-access-level-salvage = Экспедиционный
...
id-card-access-level-central-command = Секторальный комитет
