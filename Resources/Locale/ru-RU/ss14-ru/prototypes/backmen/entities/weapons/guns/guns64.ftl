...
ent-WeaponRifleAUG = AUG
    .desc = Винтовка системы булл-пап, используемая в качестве резервной штурмовой винтовки ТСФ. Она имеет встроенную цевье и прицел для повышения точности и уменьшения отдачи. Под патрон .25 винтовочный.
    .suffix = Автомат
