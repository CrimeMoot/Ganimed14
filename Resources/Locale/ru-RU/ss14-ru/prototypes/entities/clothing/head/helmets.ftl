...
ent-ClothingHeadHelmetMerc = армейский тяжёлый шлем
    .desc = Боевой шлем обычно используется солдатами, он прочный, лёгкий и пахнет порохом в перемешку с прилётами на "нуле".
    .suffix = Наёмника
