...
ent-CaptainPDA = КПК председателя
    .desc = На удивление ничем не отличается от вашего КПК.
ent-HoPPDA = КПК начальника персонала
...
ent-ParamedicPDA = КПК фельдшера
    .desc = Блестящий и стерильный.
ent-ChemistryPDA = КПК провизора
...
ent-WardenPDA = КПК участкового дежурного
...
ent-ReporterPDA = КПК журналиста
...
ent-BrigmedicPDA = КПК участкового врача
