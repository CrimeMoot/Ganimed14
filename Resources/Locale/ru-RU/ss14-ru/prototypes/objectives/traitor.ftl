...
ent-KillRandomPersonObjective = { ent-BaseTraitorObjective }
    .desc = Нашему руководству требуется, чтобы вы преподали урок. Достаточно убить цель один раз — после этого её можно оставить в покое.
ent-KillRandomHeadObjective = { ent-BaseTraitorObjective }
    .desc = Нам нужно, чтобы вы преподали ему урок. Достаточно единожды лишить его жизни — и этого будет достаточно. Удачи, агент.
