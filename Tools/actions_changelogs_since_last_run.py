...
CHANGELOG_FILES = ["Resources/Changelog/Changelog.yml", "Resources/Changelog/ChangelogSyndie.yml", "Resources/Changelog/ChangelogBkm.yml", "Resources/Changelog/ChangelogGanimed.yml"] # Corvax-MultiChangelog
